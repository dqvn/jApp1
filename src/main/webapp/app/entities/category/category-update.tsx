  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jApp1App.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="jApp1App.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jApp1App.category.description')}
              ...
              />
              <ValidatedField
                label={translate('jApp1App.category.sortOrder')}
              ...
              />
              <ValidatedField
                label={translate('jApp1App.category.dateAdded')}
              ...
              />
              <ValidatedField
                label={translate('jApp1App.category.dateModified')}
              ...
              />
              <ValidatedField
                label={translate('jApp1App.category.status')}
                id="category-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {categoryStatusValues.map(categoryStatus => (
                  <option value={categoryStatus} key={categoryStatus}>
                    {translate('jApp1App.CategoryStatus.' + categoryStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="parent"
                data-cy="parent"
                label={translate('jApp1App.category.parent')}
                type="select"
              >
                <option value="" key="0" />
                {categories
              ...
              <ValidatedField
                label={translate('jApp1App.category.product')}
                id="category-product"
                data-cy="product"
                type="select"
                multiple
