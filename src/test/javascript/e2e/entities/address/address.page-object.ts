...
export class AddressDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('jApp1App.address.delete.question'));
...
export default class AddressComponentsPage {
  ...
  async deleteAddress() {
    ...
    expect(await addressDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jApp1App.address.delete.question/);
