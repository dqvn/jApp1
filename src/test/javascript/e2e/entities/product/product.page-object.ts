...
export class ProductDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('jApp1App.product.delete.question'));
...
export default class ProductComponentsPage {
  ...
  async deleteProduct() {
    ...
    expect(await productDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jApp1App.product.delete.question/);
