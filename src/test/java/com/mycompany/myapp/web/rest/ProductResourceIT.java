...
class ProductResourceIT {
    ...
    @Test
    @Transactional
    void getAllProductsByKeywordsIsNotEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    @Test
    @Transactional
    void getAllProductsByRatingIsNotEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    @Test
    @Transactional
    void getAllProductsByDateAddedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
    ...
    @Test
    @Transactional
    void getAllProductsByDateModifiedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
